...
final class RepositoryRevisionListController
{
    ...
    #[Route('/api/v1/repository/{objectType}/revisions', name: 'repository_revision_list', methods: ['GET'], priority: 10)]
    public function __invoke(string $objectType, Request $request): JsonResponse
    {
        ...
        try {
            ...
            $items = $this->repository->listRepositoryRevisions($objectType, $query, $this->schemaRepository);
