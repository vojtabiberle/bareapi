...
final class UpdatePutRequestTest extends TestCase
{
    public function testConstructorStoresAllPropertiesCorrectly(): void
    {
        ...
        $this->assertSame(['title' => 'New Title'], $request->data);
    ...
    {
        $request = UpdatePutRequest::fromArray(['name' => 'new-name', 'data' => []]);
    ...
    {
        $data = ['title' => 'Full Replacement', 'content' => 'Complete data'];
        $request = UpdatePutRequest::fromArray(['name' => 'test', 'data' => $data]);
    ...
    {
        $request = UpdatePutRequest::fromArray(['data' => []]);
    ...
    {
        $request = UpdatePutRequest::fromArray(['name' => 'test']);
    ...
    {
        $request = UpdatePutRequest::fromArray(['name' => 'test', 'data' => []]);
    ...
    {
        $request = UpdatePutRequest::fromArray(['name' => ['invalid'], 'data' => []]);
    ...
    {
        $request = UpdatePutRequest::fromArray(['name' => 'test', 'data' => 12345]);
